...
//                   Look at my <span className="text-[#CCFF02]">work .</span>
//                 </h2>
//               </div>
...
import Navbar from "./Navbar";
import Footer from "@/components/Footer";
import ProjectsGrid from "./ProjectGrid"; // New component we'll create
...
const PortfolioPage = () => {
  ...
  // Projects data - moved to a separate file or could be fetched from an API
  const projects = [
    {
      id: 1,
      title: "GeekFolio Portfolio",
