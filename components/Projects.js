...
const PortfolioSection = () => {
  ...
  const projects = [
    {
      ...
      category: "Internship",
      image: "/images/mockups/uranium-tracker1.png",
    },
    {
      id: 2,
      title: "Luxury Modern Website",
  ...
  return (
    <>
      <section id="portfolio" className="relative font-sora p-4 lg:p-10 mt-14">
        {/* Header Section */}
        <div className="flex justify-between items-center mb-16">
          <div>
            ...
            <h2 className="text-2xl lg:text-4xl font-medium">
              <span className="block mb-2">Look at my work &</span>
              experience <span className="text-[#CCFF02]">my style</span>
            </h2>
          </div>
          <button
